...
* See xref:../machine_management/deploying-machine-health-checks.adoc#machine-health-checks-short-circuiting_deploying-machine-health-checks[Short-circuiting MachineHealthCheck remediation] for more information about short circuiting
